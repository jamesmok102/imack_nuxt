...
<!--        <span class="block py-3" style=""><a @click="goAnchor('#aboutus_index')">ABOUT</a></span>-->
...
<!--          <span class="text-center pr-5" style=""><a @click="goAnchor('#aboutus_index')">ABOUT</a></span>-->
    ...
    <div class="bg-gray-300" style="">
      <section class="pb-24  bg-cover bg-bottom bg-fixed clip h-5/6" :style="{'background-image': 'linear-gradient(rgba(0,0,0,0.8),rgba(0,0,0,0.6),rgba(0,0,0,0.3)), url(' + require('~/static/img/network-2402637.jpg') + ')'}">
        <div class="container m-auto" style="width: 100%; height: 100%;">
          <img src="../static/img/imack_whiteV2.png" class="lg:w-2/5 w-4/5" style="margin: auto; display: block; padding-top: 150px;">
        </div>
      </section>
    </div>
    ...
    <section class="lg:py-24 py-14 bg-gray-300 " id="aboutus">
      <div class="container mx-auto max-w-5xl">
        ...
        <div class="flex justify-center">
          <button class="text-3xl text-white bg-gray-600 p-3 px-6 rounded"><nuxt-link :to="localePath('/aboutus_page')">More</nuxt-link></button>
        </div>
      </div>
    </section>
    ...
    <section class="pt-24 pb-10" id="services">
      <div class="container mx-auto">
        ...
        <div class="flex justify-center mt-7">
          <button class="text-3xl text-white bg-gray-600 p-3 px-6 rounded"><nuxt-link :to="localePath('/services_page')">More</nuxt-link></button>
        </div>
      </div>
    </section>
...
<!--          <img src="https://via.placeholder.com/250">-->
        ...
        <div class="flex justify-center">
          <button class="text-3xl text-white bg-gray-600 p-3 px-6 rounded"><nuxt-link :to="localePath('/experience_page')">More</nuxt-link></button>
        </div>
      </div>
    </section>
    ...
    <section class="pb-24" id="salesagent">
      <div class="container mx-auto">
        <h2 class="text-4xl text-center mb-14 font-light">{{ $t('title_salesagent') }}</h2>
        <div class="flex justify-center mb-10">
          <img src="~/static/img/salesagent/lux.png" style="width: 200px;"/>
        </div>
        <div class="flex justify-center">
          <button class="text-3xl text-white bg-gray-600 p-3 px-6 rounded"><nuxt-link :to="localePath('/salesagent_page')">More</nuxt-link></button>
        </div>
      </div>
    </section>
    ...
    <section id="contactus" class="py-24 bg-no-repeat bg-cover bg-fixed" :style="{'background-image': 'linear-gradient(rgba(0,0,0,0.5),rgba(0,0,0,0.6)), url(' + require('~/static/img/contactus/pexels-fauxels-3183127.jpg') + ')'}">
      <div class="container mx-auto max-w-4xl">
        <h2 class="text-4xl text-center mb-14 font-light text-white">{{ $t('title_contactus') }}</h2>
        <div class="lg:flex">
        ...
        <div class="flex justify-center">
          <button class="text-3xl text-white bg-gray-600 p-3 px-6 rounded"><nuxt-link :to="localePath('/contactus_page')">More</nuxt-link></button>
        </div>
      </div>
    </section>
...
export default {
  ...
  setup() {
    ...
    //   let offsetTop = document.querySelector('#aboutus_index').offsetTop - 100
